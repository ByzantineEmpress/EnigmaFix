...
# We look for references to 0xE32C3C (16.6666ms) and 0xE32C70 (60.0f)
target_rvas = [0xE32C3C, 0xE32C70]
...
print(f"Scanning .text section (RVA range 0x{text_vaddr:X} - 0x{text_vaddr+text_size:X}) for references...")
