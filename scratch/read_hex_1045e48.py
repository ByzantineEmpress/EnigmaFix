...
offset = rva_to_offset(0x1045E48)
if offset is not None:
    val_bytes = data[offset : offset + 4]
    print(f"Bytes at 0x1045E48: {' '.join(f'{b:02X}' for b in val_bytes)}")
    print(f"Float value: {struct.unpack('<f', val_bytes)[0]}")
else:
    print("Could not resolve RVA 0x1045E48")
